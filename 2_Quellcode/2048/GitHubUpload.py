...
g = Github("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")      #connect to github via acces token
...
file = repo.get_contents("/2_Quellcode/2048/Highscore.md")                    #get content of the highscore, important as we need the path for the file we want to update
